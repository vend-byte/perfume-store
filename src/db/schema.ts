...
export const products = pgTable("products", {
  ...
  concentration: varchar("concentration", { length: 40 }).notNull().default(""),
  longevity: varchar("longevity", { length: 40 }).notNull().default(""),
  sillage: varchar("sillage", { length: 40 }).notNull().default(""),
  season: varchar("season", { length: 60 }).notNull().default(""),
